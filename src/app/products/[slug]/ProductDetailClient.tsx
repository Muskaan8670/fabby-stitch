...
export default function ProductDetailClient({
  ...
  return (
    <div className="bg-[#FAF9F6] min-h-screen text-[#121212] pt-6 pb-24">
      {/* Toast Notification */}
      {addedToCartToast && (
          ...
          <div className="lg:col-span-7 flex flex-col-reverse md:flex-row gap-4">
            ...
            <div className="relative flex-1 aspect-[4/5] bg-zinc-900 overflow-hidden border border-[#E4E4E7] group">
              <Image
                ...
                fill
                priority
                className="object-cover object-center cursor-zoom-in transition-transform duration-700 group-hover:scale-105"
                ...
                {product.colorNames.map((colorName, idx) => {
                  ...
                  return (
                    <button
                      ...
                      className={`flex items-center gap-2 px-3 py-2 border text-xs font-semibold uppercase tracking-wider transition-all ${
